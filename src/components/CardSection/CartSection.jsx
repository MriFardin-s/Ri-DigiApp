    ...
    <div className="bg-white border border-gray-100 rounded-3xl p-6 space-y-4">
        {carts.map((cart) => (
            ...
            >
                ...
                <div>
                    <button className="text-[#FF3980] hover:text-red-700 font-bold text-base transition-colors">
                        Remove
                    </button>
                </div>
            </div>
            ...
            <div className="mt-8 pt-6 border-t border-gray-100">
                <div className="flex justify-between items-center mb-6">
                    ...
                    <span className="text-2xl font-bold text-[#101727]">
                        ${carts.reduce((sum, cart) => sum + cart.price, 0)}
                    </span>
                </div>
                <button className="w-full bg-gradient-to-r from-[#4F39F6] to-[#9514FA] hover:bg-[#6D28D9] text-[#FFFFFF] font-bold py-4 rounded-2xl shadow-lg transition-all">
                    Proceed To Checkout
                </button>
            </div>
